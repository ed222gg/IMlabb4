   ...
   class RefereeMenu
    {
        ...
        private void showDate()
        {
            ...
            switch (chosenDate)
            {
                ...
                default:
                     chosenDate--; // listans index startar på noll men visas som om den har positionen 1. 
        ...
        private void chooseBranch(int chosenDate)
        {
            ...
            Console.WriteLine();  
            Branch branchToJudge = competitions[chosenDate].getBranch(1);// hårdkodad att domaren dömer i första grenen i listan
        ...
        private void judgingMenu(Competition competition, Branch branch)
        {
            ...
            foreach (String teamName in competition.getListOfCompetingTeams())
            {
                ...
                {
                    Console.Write("Poäng för {0}: ", name);
                    string points = Console.ReadLine();
                    int intPoints = int.Parse(points);
                   // checkPoints(intPoints);
                   
                }
            }
        }
/*
        public int checkPoints(int intPoints)
        {
           
            if (intPoints > 11 || intPoints < 0 )
            {
            ...
            {
                return 0; // inom accepterat intervall
            }
        }
  */
    }
